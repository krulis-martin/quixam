 ...
 */
final class Version20220517225104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE template_question (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', created_from_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', test_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', questions_group_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', external_id VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, caption VARCHAR(255) NOT NULL, data TEXT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_E9A1793D3EA4CB4D (created_from_id), INDEX IDX_E9A1793D1E5D0459 (test_id), INDEX IDX_E9A1793D8C203BE2 (questions_group_id), UNIQUE INDEX UNIQ_E9A1793D1E5D04599F75D7B0 (test_id, external_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE template_questions_group (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', created_from_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', test_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', ordering INT NOT NULL, select_count INT NOT NULL, points INT NOT NULL, external_id VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_157F3C3D3EA4CB4D (created_from_id), INDEX IDX_157F3C3D1E5D0459 (test_id), UNIQUE INDEX UNIQ_157F3C3D1E5D04599F75D7B0 (test_id, external_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE template_test (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', caption VARCHAR(255) NOT NULL, external_id VARCHAR(255) DEFAULT NULL, course_id VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_DB154619F75D7B0 (external_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
