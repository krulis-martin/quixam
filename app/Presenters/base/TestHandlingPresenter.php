...
class TestHandlingPresenter extends AuthenticatedPresenter
{
     ...
     * @return TestTerm|null on success (null is here only for PHPStan, it will never happen)
     */
    protected function getTestForModification(string $id): ?TestTerm
    {
